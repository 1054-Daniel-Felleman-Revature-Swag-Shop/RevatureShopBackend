INSERT INTO accounts(email, name, role, points) VALUES ('parkerkt77@gmail.com', 'Parker', 1, 300), ('kent.berry@revature.net', 'Kent', 0, 500),('dante.d.pizzini@gmail.com', 'Dan', 0, 200);
...
INSERT INTO point_history(fk_account, cause, change, date) VALUES ( 1, 'Excellent Work Week', 100, '2021-05-28' );
INSERT INTO point_history(fk_account, cause, change, date) VALUES ( 1, 'Purchased 2 item(s) from the shop', -200, '2021-05-28' );
