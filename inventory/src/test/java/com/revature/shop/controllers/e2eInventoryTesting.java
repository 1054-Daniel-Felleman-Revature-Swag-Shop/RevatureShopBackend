...
public class e2eInventoryTesting
{
    ...
    {
        StockItem item = new StockItem("Revature Smart Watch", 70, 90, "Misc", "Made of platinum, nuff said.", null);
    ...
    {
        StockItem item = new StockItem("Rev It Up Hat", 50, 3500, "Misc", "A sweet hat to ACCELERATE your development!", null);
