...
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Will Write Code For Food T-Shirt', 35, 100, 'Men''s Shirt', 'Seriously! Are you that desperate?', 'Small');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Arrays T-Shirt', 15, 50, 'Men''s Shirt', 'Black T-Shirt with jokes on it.', 'Small');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('2021 T-Shirt', 21, 100, 'Women''s Shirt', 'Keep calm and wear this shirt', 'Small');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('I Love Robot T-Shirt', 50, 150, 'Unisex Shirt', 'Are you an AI sympathizer? If so, wear this shirt to show some robot love, baby!', 'Small');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('I Am Supercomputer T-Shirt', 25, 200, 'Men''s Shirt', 'Have you ever wanted to be Superman, but instead of a man you want to be a computer? Then what are you waiting for? Wear this shirt NOW!', 'Small');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Pet Owner T-Shirt', 29, 80, 'Unisex Shirt', 'Wear it to brag about your newly-built robodog.', 'Small');
...
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Angry Developer T-Shirt', 35, 70, 'Unisex Shirt', 'It is not working! WHY!!!', 'Small');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Cute Robot T-Shirt', 25, 300, 'Unisex Shirt', 'Do you have kids? Do your kids like cute robots? If yes, why not do them a favor and wear this t-shirt. You will not regret it.', 'Small');
...
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('2021 T-Shirt', 21, 100, 'Women''s Shirt', 'Keep calm and wear this shirt', 'Medium');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('I Love Robot T-Shirt', 50, 150, 'Unisex Shirt', 'Are you an AI sympathizer? If so, wear this shirt to show some robot love, baby!', 'Medium');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('I Am Supercomputer T-Shirt', 25, 200, 'Men''s Shirt', 'Have you ever wanted to be Superman, but instead of a man you want to be a computer? Then what are you waiting for? Wear this shirt NOW!', 'Medium');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Pet Owner T-Shirt', 29, 80, 'Unisex Shirt', 'Wear it to brag about your newly-built robodog.', 'Medium');
...
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('2021 T-Shirt', 21, 100, 'Women''s Shirt', 'Keep calm and wear this shirt', 'Large');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('I Love Robot T-Shirt', 50, 150, 'Unisex Shirt', 'Are you an AI sympathizer? If so, wear this shirt to show some robot love, baby!', 'Large');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('I Am Supercomputer T-Shirt', 25, 200, 'Men''s Shirt', 'Have you ever wanted to be Superman, but instead of a man you want to be a computer? Then what are you waiting for? Wear this shirt NOW!', 'Large');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Pet Owner T-Shirt', 29, 80, 'Unisex Shirt', 'Wear it to brag about your newly-built robodog.', 'Large');
...
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Angry Developer T-Shirt', 35, 70, 'Unisex Shirt', 'It is not working! WHY!!!', 'Large');
INSERT INTO inventory (item_name, item_price, quantity, category, description, size) VALUES ('Cute Robot T-Shirt', 25, 300, 'Unisex Shirt', 'Do you have kids? Do your kids like cute robots? If yes, why not do them a favor and wear this t-shirt. You will not regret it.', 'Large');
